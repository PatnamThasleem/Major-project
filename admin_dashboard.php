...
$sql_videos = "SELECT * FROM videos WHERE username != 'admin' ORDER BY upload_date DESC";
...
if (isset($_POST['analyze_comments'])) {
   ...
   // var_dump($comments);
    ...
    $command = "python sentiment_analysis1.py";
...
<head>
    ...
    <style>
        ...
        .dashboard-container { max-width: 1000px; margin: auto; padding-top: 30px; }
        ...
        .video-meta { font-size: 14px; color: #666; margin-top: 5px; }
    </style>
</head>
<body>
            ...
            <?php if ($videos_result->num_rows > 0) { while ($video = $videos_result->fetch_assoc()) { ?>
                <div class="col-md-6 mb-4">
                    <div class="video-card">
                        ...
                        <p class="video-meta">Uploaded by: <strong><?php echo htmlspecialchars($video['username']); ?></strong></p>
                        <p class="video-meta">Upload Date: <strong><?php echo date('F j, Y, g:i A', strtotime($video['upload_date'])); ?></strong></p>
